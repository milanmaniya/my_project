...
import 'package:my_project/Buttons/Drawers/drawer.dart';
...
class _EndDrawerDemoState extends State<EndDrawerDemo> {
  GlobalKey<ScaffoldState> scafffoldkye = GlobalKey<ScaffoldState>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: InkWell(
          onTap: () {
            scafffoldkye.currentState!.openEndDrawer();
          },
